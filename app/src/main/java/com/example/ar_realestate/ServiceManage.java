...
public class ServiceManage {
    ...
    private static final String METHOD_NAME_DELETEAdvertisement="deleteAdv";
    ...
    public int deleteAdv(int deleteAdvId){
        int result=0;
        soapObject=new SoapObject(NAMESPACE,METHOD_NAME_DELETEAdvertisement);
        soapObject.addProperty("deleteAdvId", deleteAdvId);
        soapSerializationEnvelope=new SoapSerializationEnvelope(SoapEnvelope.VER11);
        soapSerializationEnvelope.dotNet=true;
        soapSerializationEnvelope.encodingStyle = "utf-8";
        soapSerializationEnvelope.setOutputSoapObject(soapObject);
        ...
        try{
            httpTransportSE.call(NAMESPACE+METHOD_NAME_DELETEAdvertisement,soapSerializationEnvelope);
